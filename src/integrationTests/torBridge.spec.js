...
test("Should be able to route an e2e message from client transport to lsning bridge", function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                transport = sinon_1.spy(cyphernode_js_sdk_1.cypherNodeHttpTransport());
                startBridge = cyphernodeTorBridge_1.cyphernodeTorBridge({ transport: transport }).startBridge;
                api = startBridge();
