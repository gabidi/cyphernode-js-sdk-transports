...
var getSyncMatrixClient = function (_a) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var sessionStore, matrixClient, syncFailCount;
        var _b = _a.user, user = _b === void 0 ? process.env.SIFIR_MATRIX_USER : _b, _c = _a.password, password = _c === void 0 ? process.env.SIFIR_MATRIX_PASS : _c, _d = _a.baseUrl, baseUrl = _d === void 0 ? process.env.SIFIR_MATRIX_SERVER : _d, _e = _a.deviceId, deviceId = _e === void 0 ? undefined : _e, _f = _a.storage, storage = _f === void 0 ? undefined : _f, _g = _a.acceptVerifiedDevicesOnly, acceptVerifiedDevicesOnly = _g === void 0 ? true : _g, opts = __rest(_a, ["user", "password", "baseUrl", "deviceId", "storage", "acceptVerifiedDevicesOnly"]);
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    debug("Conneting to", baseUrl, user);
                    sessionStore = new matrix_js_sdk_1.default.WebStorageSessionStore(storage);
